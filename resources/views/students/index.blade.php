            ...
            <div class="bg-white shadow-md rounded-lg overflow-x-auto">
                <div class="p-6 text-gray-900 w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($students as $student)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ \Carbon\Carbon::parse($student->dob)->format('F j, Y') }}</td>
                                    <td class="px-6 py-4 space-x-2">
                                        <!-- Edit Icon -->
                                        <a href="{{ route('students.edit', $student->id) }}" class="inline-block px-3 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600 transition">
                    ...
                    <div class="mt-4 flex justify-center">
                        <a href="{{ route('students.create') }}" class="px-4 py-2 bg-green-500 text-white text-sm rounded hover:bg-green-600 transition">
                            + Add Student
                        </a>
                    </div>
